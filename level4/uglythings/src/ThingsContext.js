...
function ThingsContextProvider(props) {
    ...
    function handleSubmit(event) {
        ...
        event.preventDefault()
        axios.post("https://api.vschool.io/davidWhite/thing/", newThing)
            .then(() => getData())
    ...
    function getData(id){
        fetch("https://api.vschool.io/davidWhite/thing/")
            .then(response => response.json())
            .then(data => setThingsList(() => [...data]))
    }
    function handleDelete(id){
        // console.log("handleDelete", id)
        axios.delete(`https://api.vschool.io/davidWhite/thing/${id}`)
    ...
    function submitEdit(id, updatedThing){
        console.log("handleEdit", id, updatedThing)
            axios.put(`https://api.vschool.io/davidWhite/thing/${id}`, updatedThing)
                .then((response) => {
